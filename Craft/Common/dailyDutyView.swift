    ...
    */
    ...
    override init(frame: CGRect) {
        ...
        self.tankIcon!.mas_makeConstraints{ make in
            ...
            make.bottom.equalTo()(self.mas_top).with().offset()(UIAdapter.shared.transferHeight(30))
            make.right.equalTo()(self.mas_left).with().offset()(UIAdapter.shared.transferWidth(30))
        }
        
        self.healIcon!.mas_makeConstraints{ make in
            make.top.equalTo()(self)
            make.left.equalTo()(self.mas_right).with().offset()(UIAdapter.shared.transferWidth(-30))
            make.bottom.equalTo()(self.mas_top).with().offset()(UIAdapter.shared.transferHeight(30))
        ...
        tankLabel!.font = UIFont(name: "DB LCD Temp", size: UIAdapter.shared.transferHeight(15))
        tankLabel!.textColor = UIColor.whiteColor()
        self.addSubview(tankLabel!)
        
        damageLabel = UILabel()
        damageLabel?.textAlignment = NSTextAlignment.Center
        damageLabel!.font = UIFont(name: "DB LCD Temp", size: UIAdapter.shared.transferHeight(15))
        damageLabel!.textColor = UIColor.whiteColor()
        self.addSubview(damageLabel!)
        
        healLabel = UILabel()
        healLabel?.textAlignment = NSTextAlignment.Center
        healLabel!.font = UIFont(name: "DB LCD Temp", size: UIAdapter.shared.transferHeight(15))
